...
### Write your component code in `src/lib/components/ReactTable.react.js`.
...
- Add custom styles to your component by putting your custom CSS files into your distribution folder (`collapsible_table`).
    - Make sure that they are referenced in `MANIFEST.in` so that they get properly included when you're ready to publish your component.
    - Make sure the stylesheets are added to the `_css_dist` dict in `collapsible_table/__init__.py` so dash will serve them automatically when the component suite is requested.
...
3. Test your tarball by copying it into a new environment and installing it locally:
    ```
    $ pip install collapsible_table-0.0.1.tar.gz
    ```
